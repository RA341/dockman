...
It is recommended to install dockman using [docker compose](#docker-compose),
but if you want to test it out first you can use the [demo command](#docker-run-demo) below
...
:::important
This is a **quick-start demo command** and will **delete all dockman data** when the container stops. Use only for testing.
...
Generate your config by using your preferred paths here
...
| `canary`    | Unstable Development builds          | `canary` | Contributing/testing unreleased features                     |
