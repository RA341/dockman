...
require (
	...
	// home/ra341/go/pkg/mod/github.com/docker/buildx@v0.30.1/util/dockerutil/api.go:41:34: cannot use dockerclient.WithTraceOptions(otelhttp.WithPropagators(propagation.NewCompositeTextMapPropagator(propagation.TraceContext{}, propagation.Baggage{}))) (value of func type "github.com/docker/docker/client".Opt) as "github.com/moby/moby/client".Opt value in argument to append
	// home/ra341/go/pkg/mod/github.com/docker/buildx@v0.30.1/util/dockerutil/api.go:45:53: cannot use clientOpts (variable of type []"github.com/moby/moby/client".Opt) as []"github.com/docker/docker/client".Opt value in argument to dockerclient.NewClientWithOpts
	// # github.com/docker/compose/v2/cmd/formatter
	// 	home/ra341/go/pkg/mod/github.com/docker/compose/v5@v5.0.0/cmd/formatter/container.go:225:36: cannot use ports (variable of type []"github.com/docker/docker/api/types/container".Port) as []"github.com/moby/moby/api/types/container".PortSummary value in argument to formatter.DisplayablePorts
	github.com/docker/cli v28.5.2+incompatible
	// todo move v5 once output bug is fixed
