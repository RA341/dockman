...
var file_docker_v1_docker_proto_msgTypes = make([]protoimpl.MessageInfo, 43)
var file_docker_v1_docker_proto_goTypes = []any{
	(SORT_FIELD)(0),                 // 0: docker.v1.SORT_FIELD
	(ORDER)(0),                      // 1: docker.v1.ORDER
	(*ImageInspectRequest)(nil),     // 2: docker.v1.ImageInspectRequest
	(*ImageInspectResponse)(nil),    // 3: docker.v1.ImageInspectResponse
	(*ImageInspect)(nil),            // 4: docker.v1.ImageInspect
	(*ImageLayer)(nil),              // 5: docker.v1.ImageLayer
	(*ComposeValidateResponse)(nil), // 6: docker.v1.ComposeValidateResponse
	(*ContainerExecCmdInput)(nil),   // 7: docker.v1.ContainerExecCmdInput
	(*ContainerExecRequest)(nil),    // 8: docker.v1.ContainerExecRequest
	(*Image)(nil),                   // 9: docker.v1.Image
	(*ManifestSummary)(nil),         // 10: docker.v1.ManifestSummary
	(*ListImagesRequest)(nil),       // 11: docker.v1.ListImagesRequest
	(*ListImagesResponse)(nil),      // 12: docker.v1.ListImagesResponse
	(*RemoveImageRequest)(nil),      // 13: docker.v1.RemoveImageRequest
	(*RemoveImageResponse)(nil),     // 14: docker.v1.RemoveImageResponse
	(*ImagePruneResponse)(nil),      // 15: docker.v1.ImagePruneResponse
	(*ImagePruneRequest)(nil),       // 16: docker.v1.ImagePruneRequest
	(*ImagesDeleted)(nil),           // 17: docker.v1.ImagesDeleted
	(*Volume)(nil),                  // 18: docker.v1.Volume
	(*ListVolumesRequest)(nil),      // 19: docker.v1.ListVolumesRequest
	(*ListVolumesResponse)(nil),     // 20: docker.v1.ListVolumesResponse
	(*CreateVolumeRequest)(nil),     // 21: docker.v1.CreateVolumeRequest
	(*CreateVolumeResponse)(nil),    // 22: docker.v1.CreateVolumeResponse
	(*DeleteVolumeRequest)(nil),     // 23: docker.v1.DeleteVolumeRequest
	(*DeleteVolumeResponse)(nil),    // 24: docker.v1.DeleteVolumeResponse
	(*Network)(nil),                 // 25: docker.v1.Network
	(*ListNetworksRequest)(nil),     // 26: docker.v1.ListNetworksRequest
	(*ListNetworksResponse)(nil),    // 27: docker.v1.ListNetworksResponse
	(*CreateNetworkRequest)(nil),    // 28: docker.v1.CreateNetworkRequest
	(*CreateNetworkResponse)(nil),   // 29: docker.v1.CreateNetworkResponse
	(*DeleteNetworkRequest)(nil),    // 30: docker.v1.DeleteNetworkRequest
	(*DeleteNetworkResponse)(nil),   // 31: docker.v1.DeleteNetworkResponse
	(*ContainerLogsRequest)(nil),    // 32: docker.v1.ContainerLogsRequest
	(*LogsMessage)(nil),             // 33: docker.v1.LogsMessage
	(*StatsResponse)(nil),           // 34: docker.v1.StatsResponse
	(*StatsRequest)(nil),            // 35: docker.v1.StatsRequest
	(*SystemInfo)(nil),              // 36: docker.v1.SystemInfo
	(*ListResponse)(nil),            // 37: docker.v1.ListResponse
	(*ContainerList)(nil),           // 38: docker.v1.ContainerList
	(*ContainerStats)(nil),          // 39: docker.v1.ContainerStats
	(*Port)(nil),                    // 40: docker.v1.Port
	(*Empty)(nil),                   // 41: docker.v1.Empty
	(*ContainerRequest)(nil),        // 42: docker.v1.ContainerRequest
	(*ComposeFile)(nil),             // 43: docker.v1.ComposeFile
	nil,                             // 44: docker.v1.Image.LabelsEntry
}
var file_docker_v1_docker_proto_depIdxs = []int32{
	4,  // 0: docker.v1.ImageInspectResponse.inspect:type_name -> docker.v1.ImageInspect
	5,  // 1: docker.v1.ImageInspect.layers:type_name -> docker.v1.ImageLayer
	44, // 2: docker.v1.Image.labels:type_name -> docker.v1.Image.LabelsEntry
	10, // 3: docker.v1.Image.manifests:type_name -> docker.v1.ManifestSummary
	9,  // 4: docker.v1.ListImagesResponse.images:type_name -> docker.v1.Image
	17, // 5: docker.v1.ImagePruneResponse.deleted:type_name -> docker.v1.ImagesDeleted
	18, // 6: docker.v1.ListVolumesResponse.volumes:type_name -> docker.v1.Volume
	25, // 7: docker.v1.ListNetworksResponse.networks:type_name -> docker.v1.Network
	36, // 8: docker.v1.StatsResponse.system:type_name -> docker.v1.SystemInfo
	39, // 9: docker.v1.StatsResponse.containers:type_name -> docker.v1.ContainerStats
	43, // 10: docker.v1.StatsRequest.file:type_name -> docker.v1.ComposeFile
	0,  // 11: docker.v1.StatsRequest.sortBy:type_name -> docker.v1.SORT_FIELD
	1,  // 12: docker.v1.StatsRequest.order:type_name -> docker.v1.ORDER
	38, // 13: docker.v1.ListResponse.list:type_name -> docker.v1.ContainerList
	40, // 14: docker.v1.ContainerList.ports:type_name -> docker.v1.Port
	42, // 15: docker.v1.DockerService.ContainerStart:input_type -> docker.v1.ContainerRequest
	42, // 16: docker.v1.DockerService.ContainerStop:input_type -> docker.v1.ContainerRequest
	42, // 17: docker.v1.DockerService.ContainerRemove:input_type -> docker.v1.ContainerRequest
	42, // 18: docker.v1.DockerService.ContainerRestart:input_type -> docker.v1.ContainerRequest
	42, // 19: docker.v1.DockerService.ContainerUpdate:input_type -> docker.v1.ContainerRequest
	41, // 20: docker.v1.DockerService.ContainerList:input_type -> docker.v1.Empty
	35, // 21: docker.v1.DockerService.ContainerStats:input_type -> docker.v1.StatsRequest
	32, // 22: docker.v1.DockerService.ContainerLogs:input_type -> docker.v1.ContainerLogsRequest
	43, // 23: docker.v1.DockerService.ComposeUp:input_type -> docker.v1.ComposeFile
	43, // 24: docker.v1.DockerService.ComposeDown:input_type -> docker.v1.ComposeFile
	43, // 25: docker.v1.DockerService.ComposeStart:input_type -> docker.v1.ComposeFile
	43, // 26: docker.v1.DockerService.ComposeStop:input_type -> docker.v1.ComposeFile
	43, // 27: docker.v1.DockerService.ComposeRestart:input_type -> docker.v1.ComposeFile
	43, // 28: docker.v1.DockerService.ComposeUpdate:input_type -> docker.v1.ComposeFile
	43, // 29: docker.v1.DockerService.ComposeList:input_type -> docker.v1.ComposeFile
	43, // 30: docker.v1.DockerService.ComposeValidate:input_type -> docker.v1.ComposeFile
	11, // 31: docker.v1.DockerService.ImageList:input_type -> docker.v1.ListImagesRequest
	13, // 32: docker.v1.DockerService.ImageRemove:input_type -> docker.v1.RemoveImageRequest
	16, // 33: docker.v1.DockerService.ImagePruneUnused:input_type -> docker.v1.ImagePruneRequest
	2,  // 34: docker.v1.DockerService.ImageInspect:input_type -> docker.v1.ImageInspectRequest
	19, // 35: docker.v1.DockerService.VolumeList:input_type -> docker.v1.ListVolumesRequest
	21, // 36: docker.v1.DockerService.VolumeCreate:input_type -> docker.v1.CreateVolumeRequest
	23, // 37: docker.v1.DockerService.VolumeDelete:input_type -> docker.v1.DeleteVolumeRequest
	26, // 38: docker.v1.DockerService.NetworkList:input_type -> docker.v1.ListNetworksRequest
	28, // 39: docker.v1.DockerService.NetworkCreate:input_type -> docker.v1.CreateNetworkRequest
	30, // 40: docker.v1.DockerService.NetworkDelete:input_type -> docker.v1.DeleteNetworkRequest
	33, // 41: docker.v1.DockerService.ContainerStart:output_type -> docker.v1.LogsMessage
	33, // 42: docker.v1.DockerService.ContainerStop:output_type -> docker.v1.LogsMessage
	33, // 43: docker.v1.DockerService.ContainerRemove:output_type -> docker.v1.LogsMessage
	33, // 44: docker.v1.DockerService.ContainerRestart:output_type -> docker.v1.LogsMessage
	41, // 45: docker.v1.DockerService.ContainerUpdate:output_type -> docker.v1.Empty
	37, // 46: docker.v1.DockerService.ContainerList:output_type -> docker.v1.ListResponse
	34, // 47: docker.v1.DockerService.ContainerStats:output_type -> docker.v1.StatsResponse
	33, // 48: docker.v1.DockerService.ContainerLogs:output_type -> docker.v1.LogsMessage
	33, // 49: docker.v1.DockerService.ComposeUp:output_type -> docker.v1.LogsMessage
	33, // 50: docker.v1.DockerService.ComposeDown:output_type -> docker.v1.LogsMessage
	33, // 51: docker.v1.DockerService.ComposeStart:output_type -> docker.v1.LogsMessage
	33, // 52: docker.v1.DockerService.ComposeStop:output_type -> docker.v1.LogsMessage
	33, // 53: docker.v1.DockerService.ComposeRestart:output_type -> docker.v1.LogsMessage
	33, // 54: docker.v1.DockerService.ComposeUpdate:output_type -> docker.v1.LogsMessage
	37, // 55: docker.v1.DockerService.ComposeList:output_type -> docker.v1.ListResponse
	6,  // 56: docker.v1.DockerService.ComposeValidate:output_type -> docker.v1.ComposeValidateResponse
	12, // 57: docker.v1.DockerService.ImageList:output_type -> docker.v1.ListImagesResponse
	14, // 58: docker.v1.DockerService.ImageRemove:output_type -> docker.v1.RemoveImageResponse
	15, // 59: docker.v1.DockerService.ImagePruneUnused:output_type -> docker.v1.ImagePruneResponse
	3,  // 60: docker.v1.DockerService.ImageInspect:output_type -> docker.v1.ImageInspectResponse
	20, // 61: docker.v1.DockerService.VolumeList:output_type -> docker.v1.ListVolumesResponse
	22, // 62: docker.v1.DockerService.VolumeCreate:output_type -> docker.v1.CreateVolumeResponse
	24, // 63: docker.v1.DockerService.VolumeDelete:output_type -> docker.v1.DeleteVolumeResponse
	27, // 64: docker.v1.DockerService.NetworkList:output_type -> docker.v1.ListNetworksResponse
	29, // 65: docker.v1.DockerService.NetworkCreate:output_type -> docker.v1.CreateNetworkResponse
	31, // 66: docker.v1.DockerService.NetworkDelete:output_type -> docker.v1.DeleteNetworkResponse
